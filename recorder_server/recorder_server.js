...
const requestListener = function (req, res) {
  ...
  if(req.method === 'POST') {
    ...
    req.on('end', function () {
      ...
      let recordedNotes = postedData.note_names;
      let splittedPlayerDocument = playerDocument.split('-!-');
      let newDocumwent = splittedPlayerDocument[0] + recordedNotes + splittedPlayerDocument[1];
      console.log(newDocumwent);
       res.writeHead(200);
      res.end(newDocumwent);
    });
